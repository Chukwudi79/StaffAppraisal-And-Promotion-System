	...
	<div class="container-fluid" id="process">
		<div class="col-md-12" id="info">
			...
			<div class="col-md-10 col-md-offset-1">
				<div class="panel  panel-danger" id="ch" style="padding: 10px;">
						<?php //echo $info; ?>
					<div class="panel-heading">
						<h1 class="text-center">All Staffs Awaiting Promotion</h1>
						<h5 class="text-center"><small class="text-danger ">Awaitnig staffs for verification and promotion by Management... </small></h5>
					</div>
							...
							<div class="row" id="responsive">
								<table class="table">
									<thead>
										...
										<td class="text-danger">Change Level</td>
										<td class="text-danger">Approve</td>
										<td class="text-danger">Withhold</td>
									</thead>
									
									<?php $classObj->mgtView(); ?>
